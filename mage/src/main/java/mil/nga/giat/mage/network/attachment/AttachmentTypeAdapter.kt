   ...
   override fun read(reader: JsonReader): Attachment {
      ...
      while(reader.hasNext()) {
         when(reader.nextName()) {
            ...
            "processingStatus" -> attachment.processingStatus = reader.nextStringOrNull()
            "processingMessage" -> attachment.processingMessage = reader.nextStringOrNull()
            "processingHook" -> attachment.processingHook = reader.nextStringOrNull()
