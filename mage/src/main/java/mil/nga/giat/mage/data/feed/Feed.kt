...
data class Feed(
   ...
   @SerializedName("itemPropertiesSchema")
   @ColumnInfo(name = "item_properties_schema")
   var itemPropertiesSchema: JsonElement? = null

   @SerializedName("constantParams")
   @ColumnInfo(name = "constant_params")
   var constantParams: JsonElement? = null

   @SerializedName("variableParams")
